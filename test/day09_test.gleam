import day09.{
  ...
  FreeSpaceMap, day_number_string, find_free_spaces_solution2,
  insert_free_space_and_cleanup, read_input, solution1, solution2,
  take_free_space,
}
import gleam/dict
  ...
  describe(day_number_string, [
    ...
    describe("solution 2", [
      ...
      it("solutionInput2", fn() {
        solution2(input2)
        |> expect.to_equal(1718)
      }),
      it("solutionInput3", fn() {
        solution2(input3)
        |> expect.to_equal(1582)
      }),
    ]),
  ])
}
